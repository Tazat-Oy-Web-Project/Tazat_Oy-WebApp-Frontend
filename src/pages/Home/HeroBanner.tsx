    ...
    <section className="bg-linear-to-r from-orange-500 to-yellow-400 text-white py-0 md:py-4 md:pb-10  mt-0 relative overflow-hidden">
        ...
        <div className="md:w-1/2 space-y-6 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start mt-6"> 
             <button className="border border-white text-white font-semibold px-6 py-3 rounded-full hover:bg-white hover:text-orange-500 transition">Contact With Us</button>
             <button className= "border border-white text-white font-semibold px-6 py-3 rounded-full hover:bg-white hover:text-orange-500 transition">Work For Us</button>
            </div> 
        </div> 
