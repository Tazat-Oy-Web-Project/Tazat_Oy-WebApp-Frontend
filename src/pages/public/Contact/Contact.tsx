                ...
                <div className="grid grid-cols-1 xl:grid-cols-10 gap-5 w-full px-4 md:px-8">
                    ...
                    <div className="flex flex-col xl:col-span-7 gap-6 bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] p-8 md:p-10 border-2 border-orange-200 hover:shadow-[0_20px_60px_rgb(0,0,0,0.25)] transition-all duration-300">
                        <div className="border-b border-gray-200 pb-4">
                            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-2">{language === "en" ? "Send Us a Message" : "Lähetä Meille Viesti"}</h2>
                            <p className="text-sm text-gray-500">{language === "en" ? "Fill out the form below and we'll get back to you shortly" : "Täytä alla oleva lomake, niin otamme sinuun yhteyttä pian"}</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="flex flex-col group">
                                <label className="text-base font-semibold text-gray-700 mb-2 transition-colors duration-200 group-focus-within:text-amber-600">
                                    {language === "en" ? "Company Name" : "Yrityksen Nimi"} <span className="text-gray-500 text-sm font-normal">({language === "en" ? "optional" : "valinnainen"})</span>
                                </label>
                                <input 
                                    type="text"
                                    name="companyName"
                    ...
                    <div className="flex flex-col xl:col-span-3 gap-6">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            >
                                ...
                                <div className="flex flex-col justify-center">
                                    <p className="text-sm font-semibold text-gray-700 group-hover:text-amber-600 transition-colors duration-300">{language === "en" ? "Call Us" : "Soita Meille"}</p>
                            ...
                            >
                                ...
                                <div className="flex flex-col justify-center">
                                    <p className="text-sm font-semibold text-gray-700 group-hover:text-amber-600 transition-colors duration-300">{language === "en" ? "Email Us" : "Lähetä Sähköpostia"}</p>
                            ...
                            >
                                ...
                                <div className="flex flex-col justify-center">
                                    <p className="text-sm font-semibold text-gray-700 group-hover:text-amber-600 transition-colors duration-300">{language === "en" ? "Visit Us" : "Käy Luonamme"}</p>
                        ...
                        <div className="flex flex-col gap-4 bg-white rounded-xl shadow-[0_4px_15px_rgb(0,0,0,0.1)] hover:shadow-[0_10px_30px_rgb(0,0,0,0.2)] p-6 border-2 border-gray-300 justify-center items-center transition-all duration-300">
                            <h3 className="text-lg font-bold text-gray-800 mb-2">{language === "en" ? "Follow Us" : "Seuraa Meitä"}</h3>
